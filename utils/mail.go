...
// MailServer : the gmail service
var MailServer *gmail.Service
...
func init() {
	credPath, _ := filepath.Abs("config/credentials.json")
...
func SendMail(userEmail string) {
	...
	_, err := MailServer.Users.Messages.Send(user, &message).Do()
